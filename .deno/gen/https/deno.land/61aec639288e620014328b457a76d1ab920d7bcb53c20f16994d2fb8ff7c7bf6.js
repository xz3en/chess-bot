                ...
                for (const processor of processors){
                    ...
                    if (Array.isArray(processor)) {
                        if (processor.length === 2) {
                            ...
                            const [prop1, re, value1] = processor;
                            target[prop1] = match ? match.replace(re, value1) : undefined;
                        } else {
                            const [prop2, re1, value2, fn] = processor;
                            assert(fn);
                            target[prop2] = match ? fn.call(prop2, match.replace(re1, value2)) : undefined;
                        }
                    } else {
